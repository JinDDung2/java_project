...
public class Names {
    ...
    public List<Student> getStudentObjects() {
        this.studentObjects.add(new Student(1, "권하준", "https://github.com/dongyeon-0822/java-project-exercise"));
        this.studentObjects.add(new Student(1, "조성윤", "https://github.com/kang-subin/Java"));
        this.studentObjects.add(new Student(3, "안예은", "https://github.com/KoKwanwun/LikeLion.git"));
        this.studentObjects.add(new Student(1, "남우빈", "https://github.com/lcomment/Algorithm_Solution--Java/tree/main/LikeLion"));
        this.studentObjects.add(new Student(2, "최경민", "https://github.com/cmkxak/likelion-java-course"));
